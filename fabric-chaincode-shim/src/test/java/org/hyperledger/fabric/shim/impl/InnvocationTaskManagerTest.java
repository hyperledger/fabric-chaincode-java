...
public final class InnvocationTaskManagerTest {

    private InnvocationTaskManager itm;
    ...
    public void setup() {
        ...
        this.itm = InnvocationTaskManager.getManager(chaincode, id);
    ...
    public void onWrongEstablishedState() throws UnsupportedEncodingException {
        ...
        // InnvocationTaskManager.getManager(chaincode, id);
        itm.onChaincodeMessage(msg);
