...
public class DataTypeDefinitionTest {
	...
	public void constructor() {
		DataTypeDefinitionImpl dtd = new DataTypeDefinitionImpl(MyType2.class);
		...
		Map<String, PropertyDefinition> properties = dtd.getProperties();
		assertThat(properties.size(), equalTo(2));
		assertThat(properties, hasKey("value"));
		assertThat(properties, hasKey("constrainedValue"));

		PropertyDefinition pd = properties.get("constrainedValue");
		Map<String,?> ts = pd.getSchema();
