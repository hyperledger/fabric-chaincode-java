...
public class ClientIdentityTest {
    ...
    public void clientIdentityWithMultipleAttributes() throws Exception {
        ChaincodeStub stub = new ChaincodeStubNaiveImpl();
        ((ChaincodeStubNaiveImpl) stub).setCertificate(TestUtil.certWithMultipleAttributes);
        ClientIdentity identity = new ClientIdentity(stub);
        assertEquals(identity.getMSPID(), "testMSPID");
    ...
    /**
     * Test client identity throws a ContractRuntimeException
     * when creating a serialized identity fails
     */
    @Test
    ...
    /**
     * Test client identity attributes are empty
     * when using a certificate with dummy attributes
     */
    @Test
    public void createClientIdentityWithDummyAttributesCert() throws Exception {
        ChaincodeStub stub = new ChaincodeStubNaiveImpl();
        // Create a certificate with rubbish attributes
        String certWithDummyAttrs = TestUtil.createCertWithIdentityAttributes("{gsdhrlxhvcilgwoueglfs,djhzxo;vjs.dcx }");
