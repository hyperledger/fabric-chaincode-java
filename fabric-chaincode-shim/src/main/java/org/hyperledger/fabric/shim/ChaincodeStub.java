...
public interface ChaincodeStub {
     ...
     */
    QueryResultsIteratorWithMetadata<KeyValue> getStateByRangeWithPagination(String startKey, String endKey,
     ...
     * @return QueryIterator
     */
    QueryResultsIteratorWithMetadata<KeyValue> getQueryResultWithPagination(String query, int pageSize,
            String bookmark);
     ...
     * @return an {@link Iterable} of {@link KeyValue}
     */
    QueryResultsIterator<KeyValue> getPrivateDataByPartialCompositeKey(String collection, String objectType,
            String... attributes);
